...
## PDF Export (Single Drill)
- [x] Landscape A4 orientation
- [x] Drill title and description
- [x] Canvas rink image
...
- [x] Layout picker — 1, 2, or 4 cards per page
- [x] Rink thumbnail per card (rendered from drill data)
- [x] Title, tags, description per card
- [x] Header — team name (left) + date (right)
